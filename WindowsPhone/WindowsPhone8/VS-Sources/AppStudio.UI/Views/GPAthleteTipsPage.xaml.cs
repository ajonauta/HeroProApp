...
namespace AppStudio
{
    public partial class GPAthleteTipsPage
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            GPAthleteTipsModel.ViewType = ViewTypes.List;
            NavigationServices.CurrentViewModel = null;
            DataContext = GPAthleteTipsModel;
            await GPAthleteTipsModel.LoadItems(NetworkInterface.GetIsNetworkAvailable());
