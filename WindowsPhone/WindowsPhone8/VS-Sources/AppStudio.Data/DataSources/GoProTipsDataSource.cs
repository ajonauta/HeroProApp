...
{
    public class GoProTipsDataSource : IDataSource<YouTubeSchema>
    {
        ...
        public async Task<IEnumerable<YouTubeSchema>> LoadData()
        {
            if (_data == null)
            {
                ...
                {
                    AppLogs.WriteError("GoProTipsDataSourceDataSource.LoadData", ex.ToString());
                }
            }
            return _data;
        }
