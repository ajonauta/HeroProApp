...
namespace AppStudio
{
    public sealed partial class PolarProView
    {
        ...
        public PolarProViewModel PolarProViewModel
        {
            get { return PolarProViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                PolarProViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            PolarProViewModel.EnableSelectionNavigation();
        }
