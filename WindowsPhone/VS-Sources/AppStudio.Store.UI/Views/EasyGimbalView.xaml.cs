...
namespace AppStudio
{
    public sealed partial class EasyGimbalView
    {
        ...
        public EasyGimbalViewModel EasyGimbalViewModel
        {
            get { return EasyGimbalViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                EasyGimbalViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            EasyGimbalViewModel.EnableSelectionNavigation();
        }
