...
namespace AppStudio
{
    public sealed partial class GoProTipsView
    {
        private NavigationHelper _navigationHelper;

        private bool _isLoadingData = false;

        public GoProTipsView()
        {
            InitializeComponent();
        ...
        {
            get { return GoProTipsViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                GoProTipsViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            GoProTipsViewModel.EnableSelectionNavigation();
        }
