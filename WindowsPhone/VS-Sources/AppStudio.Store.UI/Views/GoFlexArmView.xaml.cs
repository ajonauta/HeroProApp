...
namespace AppStudio
{
    public sealed partial class GoFlexArmView
    {
        ...
        public GoFlexArmViewModel GoFlexArmViewModel
        {
            get { return GoFlexArmViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                GoFlexArmViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            GoFlexArmViewModel.EnableSelectionNavigation();
        }
