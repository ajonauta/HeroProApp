...
namespace AppStudio
{
    public sealed partial class GoPoleView
    {
        ...
        public GoPoleViewModel GoPoleViewModel
        {
            get { return GoPoleViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                GoPoleViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            GoPoleViewModel.EnableSelectionNavigation();
        }
