...
namespace AppStudio
{
    public sealed partial class GoProDIYView
    {
        ...
        {
            get { return GoProDIYViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                GoProDIYViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            GoProDIYViewModel.EnableSelectionNavigation();
        }
