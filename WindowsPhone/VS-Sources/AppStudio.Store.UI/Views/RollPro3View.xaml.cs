...
namespace AppStudio
{
    public sealed partial class RollPro3View
    {
        ...
        public RollPro3ViewModel RollPro3ViewModel
        {
            get { return RollPro3ViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                RollPro3ViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            RollPro3ViewModel.EnableSelectionNavigation();
        }
