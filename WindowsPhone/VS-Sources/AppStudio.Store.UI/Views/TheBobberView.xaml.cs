...
namespace AppStudio
{
    public sealed partial class TheBobberView
    {
        ...
        public TheBobberViewModel TheBobberViewModel
        {
            get { return TheBobberViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                TheBobberViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            TheBobberViewModel.EnableSelectionNavigation();
        }
