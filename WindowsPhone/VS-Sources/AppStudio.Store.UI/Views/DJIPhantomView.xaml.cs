...
namespace AppStudio
{
    public sealed partial class DJIPhantomView
    {
        private NavigationHelper _navigationHelper;

        private bool _isLoadingData = false;

        public DJIPhantomView()
        {
            InitializeComponent();
        ...
        public DJIPhantomViewModel DJIPhantomViewModel
        {
            get { return DJIPhantomViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                DJIPhantomViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            DJIPhantomViewModel.EnableSelectionNavigation();
        }
