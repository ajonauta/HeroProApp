...
namespace AppStudio
{
    public sealed partial class GPAthleteTipsView
    {
        ...
        {
            get { return GPAthleteTipsViewModel.Current; }
        }
        ...
        private async Task EnsureDataLoaded()
        {
            ...
            var loadTasks = new Task[] {
                GPAthleteTipsViewModel.LoadItems(isNetworkAvailable),
            };
        ...
        {
            GPAthleteTipsViewModel.EnableSelectionNavigation();
        }
